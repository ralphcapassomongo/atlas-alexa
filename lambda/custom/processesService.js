...
module.exports = {
  fetchProcesses(groupId, clusterName) {
    ...
    return requestPromise(options).then(response => {
      ...
      return results.filter(p => p.replicaSetName === clusterName || p.shardName === clusterName);
    });
  },

  fetchMeasurementsForProcess(groupId, host, port, measurements, granularity, period) {
